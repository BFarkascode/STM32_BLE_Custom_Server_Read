...
//initiate screen
  ...
  for(uint8_t i = 1; i<128; i++) {
   ...
   //read BMP280 sensor coeficients
   ...
   //We rebuild the parameters from the readout for temperature calculations
   dig_T1 = (T_comp[1] << 8) | T_comp[0];
   dig_T2 = (T_comp[3] << 8) | T_comp[2];
   dig_T3 = (T_comp[5] << 8) | T_comp[4];
